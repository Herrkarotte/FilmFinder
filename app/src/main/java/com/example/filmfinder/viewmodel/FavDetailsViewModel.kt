...
class FavDetailsViewModel(private val model: FavModel) : ViewModel() {
    ...
    private val _posterBiteArray = mutableStateOf<ByteArray?>(null)
    val posterBiteArray: State<ByteArray?> = _posterBiteArray
    ...
    fun loadMovie(movieId: Int) {
        viewModelScope.launch {
            ...
            try {
                ...
                _posterBiteArray.value = model.getMoviePosterBytes(movieId)
